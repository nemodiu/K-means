...
def measurescore(test_data, update_centroids):
    pass
...
# 方法3 函数生成
method3_data, y = make_blobs(n_samples=100000, n_features=2, centers=[[-.7, -.7], [-.2, -.2], [.2, .2], [.7,.7]],
...
for t in range(iter_max_times):
    ...
    score=measurescore(test_data,update_centroids)
...
# print ("恢复数据:swap_perturb_zero_list_c")
# c_list_swap=[]
# swap_perturb_zero_list_c=swap_c(swap_k,perturb_zero_list_c,k_num)
# print(swap_perturb_zero_list_c.shape)
# swap_perturb_zero_list_c=swap_perturb_zero_list_c.reshape(-1,k_num)
# for x in swap_perturb_zero_list_c.T:
#     a=ldp_agg(Epsilon,x)
#     c_list_swap.append(a)
